...
parser.add_argument('--dataset', default='LastFM', help='dataset name: diginetica/yoochoose1_4/yoochoose1_64/Gowalla/LastFM/sample')
...
def main():
    ...
    for epoch in range(opt.epoch):
        ...
        hit, mrr = train_test(model, train_data, test_data, opt.random_seed, logger)
