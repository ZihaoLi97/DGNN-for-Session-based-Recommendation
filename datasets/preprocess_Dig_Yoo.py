...
prefix_digi_path = r'\\?\E:\OneDrive\Wuhan University\paper\Handling Information Loss of Graph Neural Networks for Session-based Recommendation\lessr-master\lessr-master\datasets\diginetica\CIKMCUP2016_Track2_DIGINETICA-20210804T114837Z-001\CIKMCUP2016_Track2_DIGINETICA\dataset-train-diginetica'
# prefix_digi_path = r'../'


dataset = 'sample_train-item-views.csv'
if opt.dataset == 'diginetica':
    dataset = prefix_digi_path + '\\train-item-views.csv'
...
# tr_seqs, tr_dates, tr_labs, tr_ids = process_seqs_bi(tra_seqs, tra_dates)  ## create labels
...
if opt.dataset == 'diginetica':
    ...
    pickle.dump(tra, open('diginetica/train_bi.txt', 'wb'))
